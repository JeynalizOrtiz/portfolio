...
Appelhans, T., Detsch, F., Reudenbach, C., & Woellauer, S. (2025). *mapview: Interactive
viewing of spatial data in R* (Version 2.11.4) Rpackage. 
https://CRAN.R-project.org/package=mapview

Dunnington, D. (2025). *ggspatial: Spatial data framework for ggplot2* (Version 1.1.10) 
Rpackage. https://CRAN.R-project.org/package=ggspatial

Firke, S. (2024). *janitor: Simple tools for examining and cleaning dirty data* (Version
2.2.1) Rpackage. https://CRAN.R-project.org/package=janitor
...
Miami-Dade County Parks Sea Turtle Conservation Program. (2025). 2025 sea turtle nesting
season disorientation dataset. Unpublished raw data. Miami-Dade County.
...
Villasenor-Derbez, J. C. (2025). *EVR 628: Introduction to data management and visualization
for environmental scientists*. Department of Environmental Science and Policy, University of 
